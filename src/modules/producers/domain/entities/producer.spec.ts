...
const makeFarm = (
  overrides: Partial<ConstructorParameters<typeof Farm>[0]> = {},
): Farm => {
  return new Farm({
    id: "farm-1",
...
const makeCrop = (): Crop => new Crop("crop-1", CropName.create("Soja"));

const makeHarvest = (): Harvest =>
  new Harvest("harvest-1", HarvestYear.create("2024/2025"), [makeCrop()]);

const makeProducer = (
  overrides: Partial<ConstructorParameters<typeof Producer>[0]> = {},
): Producer =>
  new Producer({
    id: "producer-1",
